...
const Rules = () => {
    ...
    return (
        <div style={{margin: 30}}>
            ...
            Uno Online is a card game played with a deck of 108 cards. The game is played with a minimum of 2 players
            and a maximum of 10 players. The game is played in rounds.
            ...
            <Row align="middle" justify="center" gutter={[32, 32]}>
                <Col>
                    <Button type="primary" style={{width: 150, height: 50, fontSize: 18}} size="large" onClick={() => navigate("/lobby")}>Join room</Button>
                </Col>
                <Col>
                    <Button type="primary" style={{width: 150, height: 50, fontSize: 18}} size="large" onClick={() => navigate("/create")}>Create room</Button>
                </Col>
            </Row>
        </div>
    )
